...
var useStore = create__default["default"](function () { return ({
...
function AnaylzerLivestream() {
    return new AudioMotionAnalyzer(undefined, {
        ...
        onCanvasDraw: function (instance) {
            useStore.setState({
                data: instance.getBars().map(function (_a) {
                    var value = _a.value;
                    return value[0];
                })
            });
...
function DataReactiveGrid(_a) {
    var amplitude = _a.amplitude, cubeSideLength = _a.cubeSideLength, cubeSpacingScalar = _a.cubeSpacingScalar, gridCols = _a.gridCols, gridRows = _a.gridRows;
    ...
    fiber.useFrame(function () {
        var data = useStore.getState().data;
        var gridSizeX = gridRows * cubeSpacingScalar * cubeSideLength;
        var gridSizeY = gridRows * cubeSpacingScalar * cubeSideLength;
        var normQuadrantHypotenuse = Math.hypot(0.5, 0.5);
...
DataReactiveGrid.propTypes = {
    ...
    cubeSpacingScalar: PropTypes__default["default"].number.isRequired,
...
function Equalizer(_a) {
    var _b = _a.amplitude, amplitude = _b === void 0 ? 1 : _b, _c = _a.backgroundColor, backgroundColor = _c === void 0 ? "" : _c, _d = _a.cubeSideLength, cubeSideLength = _d === void 0 ? 0.03 : _d, _e = _a.cubeSpacingScalar, cubeSpacingScalar = _e === void 0 ? 4.5 : _e, _f = _a.cameraFov, cameraFov = _f === void 0 ? 45 : _f, _g = _a.cameraPosition, cameraPosition = _g === void 0 ? [0, 5, 15] : _g, _h = _a.gridCols, gridCols = _h === void 0 ? 80 : _h, _j = _a.gridRows, gridRows = _j === void 0 ? 12 : _j, _k = _a.loadingFallback, loadingFallback = _k === void 0 ? React__default["default"].createElement(React__default["default"].Fragment, null) : _k, _l = _a.onCreatedCallback, onCreatedCallback = _l === void 0 ? function () { } : _l;
    return (React__default["default"].createElement(React.Suspense, { fallback: loadingFallback },
        React__default["default"].createElement(fiber.Canvas, { mode: "concurrent", camera: {
                fov: cameraFov,
            ...
            backgroundColor !== ""
                ...
                : null,
            React__default["default"].createElement(DataReactiveGrid, { amplitude: amplitude, cubeSideLength: cubeSideLength, cubeSpacingScalar: cubeSpacingScalar, gridCols: gridCols, gridRows: gridRows }),
...
Equalizer.propTypes = {
    ...
    cubeSpacingScalar: PropTypes__default["default"].number,
    ...
    onCreatedCallback: PropTypes__default["default"].func.isRequired
};

exports.AnaylzerLivestream = AnaylzerLivestream;
